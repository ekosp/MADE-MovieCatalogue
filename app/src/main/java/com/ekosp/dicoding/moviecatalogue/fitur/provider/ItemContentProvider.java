package com.ekosp.dicoding.moviecatalogue.fitur.provider;
...
public class ItemContentProvider extends ContentProvider {
     ...
     */
    private static final String AUTHORITY = "com.ekosp.dicoding.moviecatalogue.fitur.provider.ItemContentProvider";
