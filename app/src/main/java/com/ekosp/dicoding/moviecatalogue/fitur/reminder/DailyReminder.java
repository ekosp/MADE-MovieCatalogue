...
public class DailyReminder {
    ...
    // --Commented out by Inspection (2019-07-22 14:09):public static final String TAG = "DailyReminder";
    ...
    static void showVisitNotification(Context context, String title, String content) {
